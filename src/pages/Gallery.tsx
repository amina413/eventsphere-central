    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-foreground mb-4">Event Gallery</h1>
                ...
                <div className="grid grid-cols-4 gap-2 mb-4">
                  {event.images.map((image, index) => (
                    <img
                      ...
                      className="w-full h-16 object-cover rounded bg-muted cursor-pointer hover:opacity-80 transition-opacity"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {selectedEvent.images.map((image, index) => (
                    <img
                      ...
                      className="w-full h-64 object-cover rounded bg-muted"
                    />
                  ))}
                </div>
              </div>
